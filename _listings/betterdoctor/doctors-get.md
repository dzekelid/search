...
paths:
  /doctors:
    get:
      ...
      - in: query
        name: first_name
        description: The doctor's first name; partial (type-ahead) characters/names
          are accepted
      - in: query
        name: gender
        description: The doctor's gender ('male' or 'female')
      - in: query
        name: insurance_uid
        description: UID of an insurance plan (e
      - in: query
        name: last_name
        description: The doctor's last name; partial (type-ahead) characters/names
          are accepted
      - in: query
        name: limit
      ...
      - in: query
        name: name
        description: The doctor's name; searches in both first and last names
      - in: query
        name: practice_uid
